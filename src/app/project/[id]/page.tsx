          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-12 space-y-12">
            ...
            <div>
              <Link
                ...
                className="inline-flex items-center gap-2 font-mono-tech text-xs tracking-wider uppercase text-[#596B72] hover:text-[#171717] transition-colors link-underline"
              >
                <ArrowLeft size={14} />
